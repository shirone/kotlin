...
public class ClosureCodegen extends MemberCodegen<KtElement> {
    ...
    private static FunctionDescriptor createFreeLambdaDescriptor(@NotNull FunctionDescriptor descriptor) {
        assert descriptor.getTypeParameters().isEmpty() : "Descriptor for lambda cannot have type parameters: " + descriptor;

        List<TypeParameterDescriptor> typeParameters = new SmartList<TypeParameterDescriptor>();
        ...
        while (container != null) {
            ...
            else if (container instanceof CallableDescriptor) {
